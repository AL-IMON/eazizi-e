...
// Pre-select a division dropdown from a ?division= query parameter
function preselectDivision(selectId) {
...
// Investor / Partnership interest form ("Join With Us")
const joinForm = document.getElementById('joinForm');
if (joinForm) {
  preselectDivision('joinDivision');
  joinForm.addEventListener('submit', function (e) {
    e.preventDefault();
    this.reset();
    const note = document.getElementById('joinFormNote');
    if (note) note.style.display = 'block';
  });
}
...
if (orderForm) {
  preselectDivision('orderDivision');
